...
class TypeCheckVisitor : AstVisitor<TypeCheckCtx, Result<Boolean, TypeError>> {
  override fun visitSucc(succ: Succ, ctx: TypeCheckCtx): Result<Boolean, TypeError> {
    TODO("Not yet implemented")
  }

  override fun visitVar(varExpr: Var, ctx: TypeCheckCtx): Result<Boolean, TypeError> {
    TODO("Not yet implemented")
  }
  ...
  override fun visitProgram(program: Program, ctx: TypeCheckCtx): Result<Boolean, TypeError> {
    TODO("Not yet implemented")
  }
  ...
  override fun visitTypeNat(typeNat: ast.Type.Nat, ctx: TypeCheckCtx): Result<Boolean, TypeError> {
    TODO("Not yet implemented")
  }

  override fun visitTypeFun(typeFun: ast.Type.Fun, ctx: TypeCheckCtx): Result<Boolean, TypeError> {
    TODO("Not yet implemented")
  }
}
